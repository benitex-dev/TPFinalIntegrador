...
namespace negocio
{
    public class IngresoNegocio
    {
        ...
        public Ingreso ListarPorId(int idIngreso)
        {
            Ingreso ingreso = new Ingreso();
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                datos.setConsulta("SELECT I.IdIngreso, I.Descripcion, I.Fecha, I.Monto, I.IdCategoria, I.IdUsuario, I.Estado, C.Nombre AS NombreCategoria " +
                                  "FROM INGRESO I " +
                                  "INNER JOIN CATEGORIA C ON I.IdCategoria = C.IdCategoria " +
                                  "WHERE I.IdIngreso = @idIngreso AND I.Estado = 1");
        ...
        public List<Ingreso> ListarPorUsuarioMesReciente(int idUsuario)
        {
            List<Ingreso> lista = new List<Ingreso>();
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                datos.setConsulta("SELECT TOP 8 I.IdIngreso, I.Descripcion, I.Fecha, I.Monto, I.IdCategoria, I.IdUsuario, I.Estado, C.Nombre AS NombreCategoria " +
                                  "FROM INGRESO I " +
                                  "INNER JOIN CATEGORIA C ON I.IdCategoria = C.IdCategoria " +
                                  "WHERE I.IdUsuario = @idUsuario " +
                                  "AND I.Estado = 1 " +
        ...
        public List<Ingreso> ListarPorHogarPorFecha(int idHogar, int mes, int anio)
        {
            List<Ingreso> lista = new List<Ingreso>();
            AccesoDatos datos = new AccesoDatos();
        ...
        public decimal TotalIngresosPorFecha(int idUsuario, int mes, int anio)
        {
            AccesoDatos datos = new AccesoDatos();
        ...
        public decimal TotalIngresosPorFechaHogar(int idHogar, int mes, int anio)
        {
            AccesoDatos datos = new AccesoDatos();
        ...
        public void ModificarIngreso(Ingreso nuevo)
        {
            AccesoDatos datos = new AccesoDatos();
            ...
            try
            {
                ...
                datos.setConsulta(@"UPDATE INGRESO SET Descripcion = @descripcion, Fecha = @fecha, Monto = @monto, IdCategoria = @idCategoria, IdUsuario = @idUsuario, Estado = @estado WHERE IdIngreso = @idIngreso");

                datos.setParametro("@idIngreso", nuevo.IdIngreso);
                datos.setParametro("@descripcion", nuevo.Descripcion.Trim());
                datos.setParametro("@fecha", nuevo.Fecha);
                datos.setParametro("@monto", nuevo.Monto);
                datos.setParametro("@idCategoria", nuevo.Categoria.IdCategoria);
